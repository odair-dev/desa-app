    ...
    return(
        <div className={styles.container}>
            <div className={styles.maxSize}>
                <div className={styles.divText} data-aos="fade-right" data-aos-duration="1500">
                    <h2 id='detail'>Conheça os detalhes</h2>
                </div>
                <div className={styles.divImg} data-aos="fade-left" data-aos-duration="1500">
                ...
                <div className={styles.divMap} data-aos="fade-left" data-aos-duration="1500">
